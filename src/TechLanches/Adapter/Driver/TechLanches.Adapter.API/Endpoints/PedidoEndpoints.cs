...
public static class PedidoEndpoints
{
    public static void MapPedidoEndpoints(this IEndpointRouteBuilder app)
    {
        app.MapGet("api/pedidos", BuscarPedidos)
           ...
           .WithMetadata(new SwaggerResponseAttribute(404, type: typeof(ErrorResponsePresenter), description: "Pedidos não encontrados"))
        ...
        app.MapGet("api/pedidos/{idPedido}", BuscarPedidoPorId)
           ...
           .WithMetadata(new SwaggerResponseAttribute(400, type: typeof(ErrorResponsePresenter), description: "Requisição inválida"))
           .WithMetadata(new SwaggerResponseAttribute(404, type: typeof(ErrorResponsePresenter), description: "Pedido não encontrado"))
           .WithMetadata(new SwaggerResponseAttribute(500, type: typeof(ErrorResponsePresenter), description: "Erro no servidor interno"));
        ...
        app.MapPost("api/pedidos", CadastrarPedido)
           ...
           .WithMetadata(new SwaggerResponseAttribute(400, type: typeof(ErrorResponsePresenter), description: "Requisição inválida"))
           .WithMetadata(new SwaggerResponseAttribute(404, type: typeof(ErrorResponsePresenter), description: "Pedido não cadastrado"))
           .WithMetadata(new SwaggerResponseAttribute(500, type: typeof(ErrorResponsePresenter), description: "Erro no servidor interno"));
        ...
        app.MapPut("api/pedidos/{idPedido}/trocarstatus", TrocarStatus)
           ...
           .WithMetadata(new SwaggerResponseAttribute(400, type: typeof(ErrorResponsePresenter), description: "Requisição inválida"))
           .WithMetadata(new SwaggerResponseAttribute(404, type: typeof(ErrorResponsePresenter), description: "Status do pedido não alterado"))
           .WithMetadata(new SwaggerResponseAttribute(500, type: typeof(ErrorResponsePresenter), description: "Erro no servidor interno"));
        ...
        app.MapGet("api/pedidos/statuspedidos", BuscarStatusPedidos)
           ...
           .WithMetadata(new SwaggerResponseAttribute(400, type: typeof(ErrorResponsePresenter), description: "Requisição inválida"))
           .WithMetadata(new SwaggerResponseAttribute(404, type: typeof(ErrorResponsePresenter), description: "Status do pedido não encontrado"))
           .WithMetadata(new SwaggerResponseAttribute(500, type: typeof(ErrorResponsePresenter), description: "Erro no servidor interno"));
    }
        ...
        [FromServices] IPedidoService pedidoService)
    {
        ...
        return pedidos is not null
            ...
            : Results.BadRequest(new ErrorResponsePresenter { MensagemErro = "Erro ao buscar pedidos.", StatusCode = (int)HttpStatusCode.BadRequest});
    }
        ...
        [FromServices] IPedidoService pedidoService)
    {
        ...
        return pedido is not null
            ...
            : Results.NotFound(new ErrorResponsePresenter { MensagemErro = $"Pedido não encontrado para o id: {idPedido}.", StatusCode = (int)HttpStatusCode.NotFound });
    }
        ...
        [FromServices] IPedidoService pedidoService)
    {
        ...
        return pedidos is not null
            ? Results.Ok(pedidos.Adapt<List<PedidoResponseDTO>>())
            : Results.BadRequest(new ErrorResponsePresenter { MensagemErro = "Erro ao buscar pedidos por status.", StatusCode = (int)HttpStatusCode.BadRequest });
    }

    private static async Task<IResult> CadastrarPedido(
        [FromBody] PedidoRequestDTO pedidoDto,
        [FromServices] IPedidoService pedidoService, IClienteService clienteService, IProdutoController produtoService)
    {
        ...
        return novoPedido is not null
            ...
            : Results.BadRequest(new ErrorResponsePresenter { MensagemErro = "Erro ao cadastrar pedido.", StatusCode = (int)HttpStatusCode.BadRequest });
    }
        ...
        [FromServices] IPedidoService pedidoService)
    {
        ...
        return pedido is not null
            ? Results.Ok(pedido.Adapt<PedidoResponseDTO>())
            : Results.BadRequest(new ErrorResponsePresenter { MensagemErro = "Erro ao trocar status.", StatusCode = (int)HttpStatusCode.BadRequest });
    }
    ...
    private static async Task<IResult> BuscarStatusPedidos()
    {
        ...
        return statusPedidos is not null
            ...
            :Results.NotFound(new ErrorResponsePresenter { MensagemErro = "Nenhum status encontrado.", StatusCode = (int)HttpStatusCode.NotFound });
    }
}