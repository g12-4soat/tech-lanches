    ...
    public static class FilaPedidosEndpoints
    {
        public static void MapFilaPedidoEndpoints(this IEndpointRouteBuilder app)
        {
            app.MapGet("api/filapedidos", RetornarFilaPedidos)
               ...
               .WithMetadata(new SwaggerResponseAttribute(404, type: typeof(ErrorResponsePresenter), description: "Pedidos da fila não encontrados"))
            ...
            [FromServices] IPedidoService pedidoService)
        {
            ...
            return pedidos is not null
                ...
                : Results.BadRequest(new ErrorResponsePresenter { MensagemErro = "Erro ao retornar fila pedido.", StatusCode = (int)HttpStatusCode.BadRequest });
            ;
        }
    }
}