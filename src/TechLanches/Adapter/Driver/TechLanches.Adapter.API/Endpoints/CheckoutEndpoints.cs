    ...
    public static class CheckoutEndpoints
    {
        public static void MapCheckoutEndpoints(this IEndpointRouteBuilder app)
        {
            app.MapPost("api/checkout", Checkout)
               ...
               .WithMetadata(new SwaggerResponseAttribute(404, type: typeof(ErrorResponsePresenter), description: "Falha ao realizar o checkout"))
                           ...
                           IPedidoService pedidoService)
        {
            ...
            return checkout is true
                    ...
                    : Results.BadRequest(new ErrorResponsePresenter { MensagemErro = $"Falha ao realizar checkout.", StatusCode = (int)HttpStatusCode.BadRequest });
        }                                
    }
}
